...
export const curriculumAmharic: Subject[] = [
  ...
  // 12. ኢኮኖሚክስ (Economics)
  {
    ...
    topics: [
      {
        id: 'economics-9-10',
        title: 'የኢኮኖሚክስ መሰረተ-ሀሳቦች እና የገበያ ስርዓት (Fundamentals of Economics & Market Systems)',
        gradeTier: '9-10',
        applicableGrades: [9, 10],
        lessonTitle: 'የእጥረት ፅንሰ-ሀሳብ፣ ምርጫ፣ የፍላጎትና አቅርቦት ህጎች',
        competencies: [
          'የኢኮኖሚክስን መሰረታዊ ትርጓሜ እና የእጥረት (Scarcity) ባህሪን መተንተን',
          'የዕድል ወጪን (Opportunity Cost) በዕለት ተዕለት ውሳኔዎች ውስጥ ማስላት',
          'የፍላጎት ህግን (Law of Demand) እና የአቅርቦት ህግን (Law of Supply) ማወዳደር',
          'የገበያ ሚዛን ዋጋ (Equilibrium Price) እና መጠኑን በሰንጠረዥና ግራፍ መግለጽ'
        ],
        practicalActivity: {
          title: 'የአካባቢ የሸቀጥ ገበያ የፍላጎትና አቅርቦት ጥናት (Market Supply & Demand Survey)',
          materials: ['ማስታወሻ ደብተር', 'የዋጋ መከታተያ ቅጽ', 'የካልኩሌተር ስሌት'],
          steps: [
            '1. በአካባቢ ገበያ ውስጥ የአንድን ምርት (ለምሳሌ የጤፍ ወይም የስንዴ) የ3 ወራት የዋጋ ለውጥ መረጃ ሰብስብ።',
            '2. ዋጋው በጨመረ ቁጥር የሸማቾች ፍላጎት እንዴት እንደተለወጠ መዝግብ።',
            '3. የፍላጎት ከርቭ (Demand Curve) እና የአቅርቦት ከርቭ (Supply Curve) በግራፍ ላይ አስቀምጥ።'
          ],
          observation: 'ዋጋ ሲጨምር የተጠቃሚዎች ፍላጎት ይቀንሳል፤ የአምራቾች አቅርቦት ደግሞ ይጨምራል። ሁለቱ የሚገናኙበት ነጥብ የገበያ ሚዛን ይባላል።'
        },
        lessonContent: [
          'ኢኮኖሚክስ ማህበረሰቦች ውስን የሆኑ የተፈጥሮና ሰው ሰራሽ ሀብቶችን ተጠቅመው ያልተገደቡ የሰው ልጅ ፍላጎቶችን እንዴት እንደሚያሟሉ የሚያጠና ማህበራዊ ሳይንስ ነው። እጥረት (Scarcity) የኢኮኖሚክስ መነሻ ችግር ሲሆን፣ ውስን ሀብት ስላለ ሁልጊዜ ምርጫ (Choice) ማድረግ ግዴታ ነው።',
          'የዕድል ወጪ (Opportunity Cost) ማለት አንድን አማራጭ ስንመርጥ የምንተወው ቀጣዩ ምርጥ አማራጭ ዋጋ ነው። ለምሳሌ ተማሪው ለፈተና ማጥናት ሲመርጥ ኳስ የመጫወትን ደስታ መስዋዕት ያደርጋል። አራቱ የምርት ግብአቶች፡ መሬት (Land)፣ ጉልበት (Labour)፣ ካፒታል (Capital) እና ስራ ፈጠራ (Entrepreneurship) ናቸው።',
          'የፍላጎት ህግ (Law of Demand) እንደሚያስረዳው ሌሎች ነገሮች ሳይለወጡ (Ceteris Paribus) የአንድ እቃ ዋጋ ሲጨምር የሚፈለገው መጠን ይቀንሳል፤ ዋጋ ሲቀንስ ደግሞ ይጨምራል። የአቅርቦት ህግ (Law of Supply) ደግሞ በተቃራኒው ዋጋ ሲጨምር አቅራቢዎች ብዙ ምርት ወደ ገበያ ያወጣሉ ይላል። ሁለቱ ሃይሎች የሚገናኙበት የገበያ ሚዛን (Equilibrium) ይባላል።'
        ],
        keyPoints: [
          'እጥረት (Scarcity)፡ ያልተገደበ ፍላጎት እና ውስን ሀብት መኖር',
          'የዕድል ወጪ (Opportunity Cost)፡ ምርጫ ስናደርግ የምንተወው ቀጣዩ ምርጥ ጥቅም',
          'አራቱ የምርት ግብአቶች፡ መሬት፣ ጉልበት፣ ካፒታል እና ስራ ፈጠራ',
          'የገበያ ሚዛን (Equilibrium)፡ የፍላጎት መጠን ከአቅርቦት መጠን ጋር እኩል የሚሆንበት ነጥብ'
        ],
        flashcards: [
          {
            id: 'ec1-fc1',
            front: 'የዕድል ወጪ (Opportunity Cost) ምንድን ነው?',
            back: 'አንድን አማራጭ ስንመርጥ የምናጣው ቀጣዩ ሁለተኛ ምርጥ አማራጭ ዋጋ ወይም ጥቅም ነው።'
          },
          {
            id: 'ec1-fc2',
            front: 'የፍላጎት ህግ (Law of Demand) ምን ይላል?',
            back: 'ሌሎች ነገሮች ቋሚ ሆነው የሸቀጡ ዋጋ ሲጨምር የፍላጎት መጠን ይቀንሳል፤ ዋጋ ሲቀንስ ይጨምራል።'
          },
          {
            id: 'ec1-fc3',
            front: 'አራቱ ዋና ዋና የምርት ግብአቶች (Factors of Production) የትኞቹ ናቸው?',
            back: 'መሬት (Land)፣ ጉልበት (Labour)፣ ካፒታል (Capital) እና ስራ ፈጠራ (Entrepreneurship)።'
          },
          {
            id: 'ec1-fc4',
            front: 'የገበያ ሚዛን ዋጋ (Equilibrium Price) መቼ ይፈጠራል?',
            back: 'የተጠቃሚዎች የፍላጎት መጠን ከአምራቾች የአቅርቦት መጠን ጋር ትክክል እኩል ሲሆን።'
          }
        ],
        quizQuestions: [
          {
            id: 'ec1-q1',
            question: 'የኢኮኖሚክስ ጥናት ዋነኛ መነሻ መሰረት የሆነው ችግር የትኛው ነው?',
            options: [
              'የሀብት እጥረት እና የሰው ልጅ ያልተገደበ ፍላጎት (Scarcity)',
              'የገንዘብ ማተሚያ ማሽኖች እጥረት',
              'የባንክ ቅርንጫፎች አለመስፋፋት',
              'የሸማቾች ቁጥር መቀነስ'
            ],
            correctIndex: 0,
            explanation: 'እጥረት (Scarcity) የሰው ልጅ ፍላጎት ማለቂያ የሌለው ሆኖ ሀብት ግን ውስን መሆኑን የሚያሳይ የኢኮኖሚክስ ዋነኛ ችግር ነው።'
          },
          {
            id: 'ec1-q2',
            question: 'አንድ ተማሪ 100 ብር ይዞ መጽሐፍ ወይም ኳስ መግዛት ይችላል። መጽሐፉን ከገዛ የዕድል ወጪው (Opportunity Cost) ምንድን ነው?',
            options: [
              'ኳሱን ባለመግዛት ያጣው ደስታ እና ጥቅም',
              '100 ብሩ ገንዘብ',
              'የመጽሐፉ ዋጋ',
              'ወደ ሱቅ የተጓዘበት ድካም'
            ],
            correctIndex: 0,
            explanation: 'የዕድል ወጪ የተተወው ቀጣዩ ምርጥ አማራጭ ዋጋ ነው፤ ስለዚህ ኳሱን መተው ነው።'
          },
          {
            id: 'ec1-q3',
            question: 'የአንድ እቃ ዋጋ ሲጨምር ሸማቾች የሚገዙት መጠን መቀነሱ የሚያሳየው የትኛውን ህግ ነው?',
            options: [
              'የፍላጎት ህግ (Law of Demand)',
              'የአቅርቦት ህግ (Law of Supply)',
              'የምርታማነት ህግ (Law of Diminishing Returns)',
              'የገበያ ሚዛን ህግ'
            ],
            correctIndex: 0,
            explanation: 'የፍላጎት ህግ በዋጋ እና በፍላጎት መጠን መካከል ያለውን ተቃራኒ ዝምድና ይገልጻል።'
          },
          {
            id: 'ec1-q4',
            question: 'ከሚከተሉት ውስጥ አደጋን ተጋፍጦ ሀብቶችን በማቀናጀት አዲስ ድርጅት የሚመሰርተው የምርት ግብአት የትኛው ነው?',
            options: [
            ...
            correctIndex: 0,
            explanation: 'ስራ ፈጣሪ (Entrepreneur) ሃሳብ በማመንጨት፣ አደጋን ተጋፍጦ ሀብቶችን አቀናጅቶ ምርት ያመርታል።'
          }
        ]
      },
      {
        id: 'economics-11-12',
        title: 'ማክሮ-ኢኮኖሚክስ እና የኢኮኖሚ እድገት (Macroeconomics & Economic Growth)',
        gradeTier: '11-12',
        applicableGrades: [11, 12],
        lessonTitle: 'ጠቅላላ የሀገር ውስጥ ምርት (GDP)፣ የገንዘብ ፖሊሲ፣ የዋጋ ግሽበት እና አለም አቀፍ ንግድ',
        competencies: [
          'ጠቅላላ የሀገር ውስጥ ምርት (GDP) ስሌት ዘዴዎችን (Expenditure & Income Approach) መተንተን',
          'የዋጋ ግሽበት (Inflation) መንስኤዎችን እና መቆጣጠሪያ ፖሊሲዎችን መለየት',
          'የብሔራዊ ባንክ የገንዘብ ፖሊሲ (Monetary Policy) እና የመንግስት የበጀት ፖሊሲ (Fiscal Policy) ሚናዎችን መገምገም',
          'የአለም አቀፍ ንግድ ሚዛን (Balance of Trade) እና የውጭ ምንዛሪ ተመን አሰራርን መመርመር'
        ],
        practicalActivity: {
          title: 'የኢትዮጵያ የዋጋ ግሽበት እና የ GDP እድገት ትንተና (Macroeconomic Indicators Case Study)',
          materials: ['የኢትዮጵያ ስታትስቲክስ አገልግሎት አመታዊ ሪፖርት', 'የብሔራዊ ባንክ ፖሊሲ መግለጫ'],
          steps: [
            '1. ባለፉት 3 አመታት ውስጥ የኢትዮጵያ የጠቅላላ የሀገር ውስጥ ምርት (GDP) እድገት ምጣኔን መዝግብ።',
            '2. የሸማቾች የዋጋ መመዘኛ ኢንዴክስ (CPI - Consumer Price Index) በመጠቀም የዋጋ ግሽበትን አስላ።',
            '3. ማዕከላዊ ባንኩ የወለድ ምጣኔን በማስተካከል የገንዘብ ዝውውርን እንዴት እንደሚቆጣጠር ገምግም።'
          ],
          observation: 'የገንዘብ አቅርቦት ከኢኮኖሚው ምርት በላይ ሲጨምር የገንዘብ የመግዛት አቅም ይቀንሳል፤ ይህም የዋጋ ግሽበት ያስከትላል።'
        },
        lessonContent: [
          'ማክሮ-ኢኮኖሚክስ የጠቅላላውን ሀገር ኢኮኖሚያዊ አፈጻጸም፣ የስራ እድል፣ የዋጋ ንረትና የሀገራዊ ገቢ እድገትን የሚያጠና ዘርፍ ነው። ዋናው መለኪያ ጠቅላላ የሀገር ውስጥ ምርት (Gross Domestic Product - GDP) ሲሆን፣ በአንድ አመት ውስጥ በአንድ ሀገር ድንበር ውስጥ የተመረቱ የመጨረሻ እቃዎችና አገልግሎቶች የገንዘብ ዋጋ ድምር ነው።',
          'የመንግስት ኢኮኖሚያዊ ፖሊሲዎች በሁለት ይከፈላሉ፡ ፊስካል ፖሊሲ (Fiscal Policy) በመንግስት ወጪና ታክስ ላይ የሚያተኩር ሲሆን፣ ሞኔታሪ ፖሊሲ (Monetary Policy) ደግሞ በማዕከላዊ ባንክ (National Bank of Ethiopia) አማካኝነት የወለድ ምጣኔና የገንዘብ አቅርቦትን የሚቆጣጠር ነው።',
          'የዋጋ ግሽበት (Inflation) አጠቃላይ የሸቀጦችና አገልግሎቶች ዋጋ በከፍተኛ ሁኔታና በተከታታይ መጨመር ነው። አለም አቀፍ ንግድ (International Trade) ሀገራት ባላቸው አንጻራዊ የጥቅም ብልጫ (Comparative Advantage) መሰረት እንዲገበያዩ፣ የውጭ ምንዛሪ እንዲያገኙ እና የኢኮኖሚ ትስስር እንዲፈጥሩ ያግዛል።'
        ],
        keyPoints: [
          'ጠቅላላ የሀገር ውስጥ ምርት (GDP)፡ በአንድ ሀገር ውስጥ የተመረቱ የመጨረሻ ምርቶች ድምር ዋጋ',
          'ፊስካል ፖሊሲ (Fiscal Policy)፡ የመንግስት ታክስ እና የበጀት ወጪ አስተዳደር',
          'ሞኔታሪ ፖሊሲ (Monetary Policy)፡ የማዕከላዊ ባንክ የወለድ ምጣኔ እና የገንዘብ ዝውውር ቁጥጥር',
          'የዋጋ ግሽበት (Inflation)፡ አጠቃላይ የዋጋ ደረጃ በተከታታይ መጨመር እና የገንዘብ የመግዛት አቅም መዳከም'
        ],
        flashcards: [
          {
            id: 'ec2-fc1',
            front: 'ጠቅላላ የሀገር ውስጥ ምርት (GDP) ምንድን ነው?',
            back: 'በአንድ ሀገር ወሰን ውስጥ በአንድ አመት የተመረቱ የመጨረሻ እቃዎች እና አገልግሎቶች አጠቃላይ የገበያ ዋጋ ድምር ነው።'
          },
          {
            id: 'ec2-fc2',
            front: 'በፊስካል ፖሊሲ (Fiscal Policy) እና በሞኔታሪ ፖሊሲ (Monetary Policy) መካከል ያለው ልዩነት ምንድን ነው?',
            back: 'ፊስካል ፖሊሲ በመንግስት ታክስና ወጪ የሚመራ ሲሆን፤ ሞኔታሪ ፖሊሲ በማዕከላዊ ባንክ የገንዘብ አቅርቦትና ወለድ ቁጥጥር የሚካሄድ ነው።'
          },
          {
            id: 'ec2-fc3',
            front: 'የዋጋ ግሽበት (Inflation) በሸማቾች ላይ የሚያስከትለው ዋነኛ ተጽዕኖ ምንድን ነው?',
            back: 'የገንዘብ የመግዛት አቅምን ይቀንሳል፤ በተመሳሳይ ገንዘብ አነስተኛ እቃ ብቻ እንዲገዛ ያደርጋል።'
          },
          {
            id: 'ec2-fc4',
            front: 'አንጻራዊ የጥቅም ብልጫ (Comparative Advantage) ፅንሰ-ሀሳብ ምን ያስረዳል?',
            back: 'አንዲት ሀገር በዝቅተኛ የዕድል ወጪ (Opportunity Cost) ማምረት በምትችለው ምርት ላይ አተኩራ በአለም አቀፍ ንግድ መሳተፍ እንዳለባት።'
          }
        ],
        quizQuestions: [
          {
            id: 'ec2-q1',
            question: 'የአንድን ሀገር አጠቃላይ አመታዊ የኢኮኖሚ መጠን ለመለካት በብዛት ጥቅም ላይ የሚውለው መለኪያ የትኛው ነው?',
            options: [
              'ጠቅላላ የሀገር ውስጥ ምርት (GDP)',
              'የውጭ ምንዛሪ ክምችት መጠን ብቻ',
              'የንግድ ባንኮች ቁጥር',
              'የወርቅ ገበያ ዋጋ'
            ],
            correctIndex: 0,
            explanation: 'GDP በአንድ አመት ውስጥ የተመረቱ አጠቃላይ እቃዎችና አገልግሎቶች የገበያ ዋጋ ድምር በመሆኑ ዋናው የኢኮኖሚ መለኪያ ነው።'
          },
          {
            id: 'ec2-q2',
            question: 'በኢትዮጵያ የገንዘብ ፖሊሲን (Monetary Policy) በማውጣትና የገንዘብ ዝውውርን በመቆጣጠር ኃላፊነት የተሰጠው ተቋም የትኛው ነው?',
            options: [
            ...
            correctIndex: 0,
            explanation: 'የኢትዮጵያ ብሔራዊ ባንክ (ማዕከላዊ ባንክ) የገንዘብ ፖሊሲን የመቅረጽና የመቆጣጠር ህጋዊ ስልጣን አለው።'
          },
          {
            id: 'ec2-q3',
            question: 'መንግስት የኢኮኖሚ መቀዛቀዝ ሲያጋጥም ኢኮኖሚውን ለማነቃቃት የሚወስደው የፊስካል ፖሊሲ እርምጃ የትኛው ነው?',
            options: [
              'የመንግስት ወጪን መጨመር እና ታክስ መቀነስ (Expansionary Fiscal Policy)',
              'ታክስን በከፍተኛ መጠን መጨመር',
              'የልማት ፕሮጀክቶችን ሙሉ በሙሉ ማቆም',
              'የባንክ ወለድን በከፍተኛ ደረጃ ማሳደግ'
            ],
            correctIndex: 0,
            explanation: 'ኢኮኖሚን ለማነቃቃት መንግስት ወጪውን ጨምሮ ታክስን በመቀነስ የገበያ ፍላጎትን ያሳድጋል።'
          },
          {
            id: 'ec2-q4',
            question: 'የዋጋ ግሽበት (Inflation) ዋነኛ መንስኤ ከሚባሉት አንዱ የትኛው ነው?',
            options: [
              'የገንዘብ አቅርቦት ከእቃዎችና አገልግሎቶች ምርት በላይ በከፍተኛ ፍጥነት መጨመር',
              'የእርሻ ምርታማነት በከፍተኛ ደረጃ መጨመር',
              'የህዝብ ቁጥር በድንገት መቀነስ',
              'የሸቀጦች ዋጋ በገበያ ላይ መውረድ'
            ],
            correctIndex: 0,
            explanation: 'በገበያ ላይ ካሉ ምርቶች በላይ ከመጠን ያለፈ ገንዘብ ሲዘዋወር (Demand-pull/Money supply) ዋጋ ይንራል።'
          }
        ]
      }
    ]
